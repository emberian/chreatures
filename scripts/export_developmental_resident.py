    ...
    metadata = {
        ...
        "recurrent_predictor": {
            ...
            "runtime_scoring": {
                ...
                "recalled_proposal_suffix": "actual previously executed contiguous actions, initial length4..8 or remaining length1..7; score ends at its observed length",
                "goal_error_rms": predictor_metadata["validation"][
                    "goal_calibration"
                ]["empirical_goal_rms_by_horizon"][0:8],
            },
        },
