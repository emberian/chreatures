#!/usr/bin/env python3
"""Convert one authenticated predecessor checkpoint into the current Torch birth."""
...
def main() -> int:
    ...
    conversion = {
        "format": "chreatures-v3-to-v4-torch-cold-birth-v2",
        "source": {
    ...
    identity = {
        "format": FORMAT,
        "config": asdict(RichSensorimotorConfig()),
