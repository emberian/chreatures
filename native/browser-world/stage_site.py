...
manifest={'format':'chreatures-browser-physics-assets-v2','engine':'mujoco-3.12.0-wasm-browser-epoch-2','upstream':{'name':'@mujoco/mujoco','version':'3.12.0','source':'https://github.com/google-deepmind/mujoco/tree/3.12.0/wasm','license':'Apache-2.0','license_path':'vendor/mujoco/LICENSE'},'original_code_license':'AGPL-3.0-or-later','fixture_notice':'Engineered twelve-hinge body with synthetic antagonist actuators and anatomical optic membership; no body, muscle or NMJ anatomy claim. Source and data notices remain in repository NOTICE.md and fixture metadata.','assets':assets}
