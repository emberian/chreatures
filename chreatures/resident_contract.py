...
NATIVE_POPULATION_FORMAT = "chreatures-native-developmental-resident-population-v7"
NATIVE_EXECUTION = "developmental-resident-native-population-v7"
NATIVE_POPULATION_VERSION = 7
